    ...
    <div className="h-full bg-slate-900 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img src="/icons/icon-128.png" alt="wAIllet" className="w-20 h-20 mx-auto mb-4" />
          <h1 className="text-2xl font-bold" style={{ fontFamily: "'Comic Sans MS', 'Comic Sans', cursive" }}>wAIllet</h1>
